...
1. What is the DOM? The Document Object Model is data that comprises the foundation of a document on the web. An example of this is HTML. It's essentially the skeleton for all webpages. 
